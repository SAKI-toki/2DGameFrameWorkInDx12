...
public:
	...
	bool GetButtonDown(size_t index, BUTTON b)const noexcept;
	bool GetButton(size_t index, BUTTON b)const noexcept;
	bool GetButtonUp(size_t index, BUTTON b)const noexcept;
	float GetTrigger(size_t index, const bool right)const noexcept;
	float GetStick(size_t index, const bool right, const bool x)const noexcept;
};
